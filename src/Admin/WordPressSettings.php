...
abstract class WordPressSettings
{
	...
	public function validate_textarea( $key )
	{
		...
		if ( isset($this->posted_data[ $key ]) )
		{
			$text = wp_kses(trim(stripslashes($this->posted_data[ $key ])), array_merge([
        ...
        <tr>
            ...
            <td>
                <input type="<?php echo $type; ?>" name="<?php echo $name; ?>" id="<?php echo $name; ?>"
                       value="<?php echo $default; ?>" placeholder="<?php echo $placeholder; ?>"/>
				<?php if ( $desc != '' )
				{
        ...
        <tr>
            ...
            <td>
                <textarea name="<?php echo $name; ?>" id="<?php echo $name; ?>"
                          placeholder="<?php echo $placeholder; ?>"><?php echo $default; ?></textarea>
				<?php if ( $desc != '' )
				{
					echo '<p class="description">' . $desc . '</p>';
				} ?>
	...
	public function render_wpeditor( $field )
	{
        ...
        <tr>
            ...
            <td>
				<?php wp_editor($default, $name, [ 'wpautop' => false ]); ?>
				<?php if ( $desc != '' )
				{
					echo '<p class="description">' . $desc . '</p>';
				} ?>
        ...
        <tr>
            ...
            <td>
                <select name="<?php echo $name; ?>" id="<?php echo $name; ?>">
					...
					{
						echo '<option ' . selected($default, $value,
								false) . ' value="' . $value . '">' . $text . '</option>';
					}
					?>
                </select>
				<?php if ( $desc != '' )
	...
	public function render_radio( $field )
	{
        ...
        <tr>
            ...
            <td>
				...
				foreach ( $options as $value => $text )
				{
					echo '<input name="' . $name . '" id="' . $name . '" type="' . $type . '" ' . checked($default,
							$value, false) . ' value="' . $value . '">' . $text . '</option><br/>';
				}
				?>
				<?php if ( $desc != '' )
				{
	...
	public function render_checkbox( $field )
	{
        ...
        <tr>
            ...
            <td>
                <input <?php checked($default, '1', true); ?> type="<?php echo $type; ?>" name="<?php echo $name; ?>"
                                                              id="<?php echo $name; ?>" value="1"
